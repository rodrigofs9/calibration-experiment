...
if __name__ == '__main__':
    ...
    dataset = MLDataset()
    dataset.load_local_movielens_dataset("./datasets/ml-20m", type="20m-new")
    ...
    if dataset is not None:
        ...
        for fold in [1]:
            for tradeoff in [0.0, 1.0]:
                ...
                df.to_csv(f"./results/ml-20m/bpr_{time.time()}_{tradeoff}_{fold}_complete_index.csv")